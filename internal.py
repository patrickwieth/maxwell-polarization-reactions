...
class material_constants:
	def __init__(self, k_aab0, k_baa0, k_abc0, k_cab0, k_caaa0, alpha_aab, alpha_baa, alpha_abc, alpha_cab, beta_aab, beta_abc, dP, epsilon_ra, epsilon_rb, epsilon_rc, tau_a, tau_b, tau_c, D_a, D_b, D_c):
		self.k_aab0 =  k_aab0
		self.k_baa0 = k_baa0
		self.k_abc0 = k_abc0
		self.k_cab0 = k_cab0
...
class cell (object):
	def __init__(self, constants, parameter, initial_condition):
		...
		self.internal_update = partial(self.internal_update_in_general, 
			parameter.epsilon_0, 
			constants.k_aab0, constants.k_baa0, constants.k_abc0, constants.k_cab0, constants.k_caaa0,
	...
	def internal_update_in_general(self, epsilon_0, k_aab0, k_baa0, k_abc0, k_cab0, k_caaa0, alpha_aab, alpha_baa, alpha_abc, alpha_cab, beta_aab, beta_abc, dP, epsilon_ra, epsilon_rb, epsilon_rc, tau_a, tau_b, tau_c, dt):
		# write history
