...
E_field = environment.external_field(strength=1.0, frequency=1.0, wave_length=50)
turing_env = environment.simulation_parameters(epsilon_0 = 1, dx = 0.1, dt = 0.01, external_fields = [E_field])
...
fig, axes, = plt.subplots(1, subplots, sharex='col', sharey='row', figsize=(20,7))

plotrange_P = [-1.0, 1.0]
plotrange_n_c = [0.04, 0.06]
